      ...
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          ...
          >
            ...
            <p className="text-xs text-muted-foreground uppercase tracking-wider">Propiedades Publicadas</p>
          </div>
          ...
          >
            ...
            <p className="text-xs text-muted-foreground uppercase tracking-wider">Ciudades</p>
          </div>
