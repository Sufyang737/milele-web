...
export function FeaturesSection() {
  ...
  return (
    <section 
      ...
      className="py-24 lg:py-32 px-6 relative overflow-hidden bg-gradient-to-b from-white to-zinc-50/50"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-normal mb-6 text-balance">
        ...
        >
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-red-600 to-red-500 bg-clip-text text-transparent mb-2">
                {stat.value}
              </div>
          ...
          <div className="space-y-6">
            {reasons.map((reason, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ x: 10 }}
                className="group flex gap-5 p-5 rounded-2xl hover:bg-white hover:shadow-xl hover:shadow-zinc-200/50 transition-all duration-300 cursor-default"
              >
                <div className={`flex-shrink-0 w-14 h-14 rounded-2xl bg-gradient-to-br ${reason.color} flex items-center justify-center shadow-lg shadow-red-500/20 group-hover:scale-110 transition-transform duration-300`}>
                  <reason.icon className="w-7 h-7 text-white" strokeWidth={1.5} />
                </div>
                <div className="flex-1">
                  <h3 className="text-lg font-semibold mb-2 text-foreground group-hover:text-red-600 transition-colors">
                    {reason.title}
                  </h3>
            ...
            >
              <a 
                href="#contacto" 
                className="inline-flex items-center gap-2 px-6 py-3 bg-red-600 text-white rounded-full font-medium hover:bg-red-700 transition-all hover:gap-3 hover:shadow-lg hover:shadow-red-500/25"
              >
            ...
            >
              ...
              <div className="relative">
                ...
                <motion.div
                  ...
                  className="absolute -left-4 top-1/4 bg-white rounded-xl p-3 shadow-xl shadow-zinc-200/50 border border-zinc-100"
                >
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center">
                      <CheckCircle2 className="w-4 h-4 text-green-600" />
                    </div>
                    <span className="text-xs font-semibold text-zinc-700">Registro<br/>GCBA</span>
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="absolute -right-4 bottom-1/3 bg-white rounded-xl p-3 shadow-xl shadow-zinc-200/50 border border-zinc-100"
                >
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center">
                      <Award className="w-4 h-4 text-red-600" />
                    </div>
                    <span className="text-xs font-semibold text-zinc-700">Yukon<br/>Partner</span>
                  </div>
                </motion.div>
              </div>
            </motion.div>
